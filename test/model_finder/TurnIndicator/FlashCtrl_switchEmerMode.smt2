...
(assert (= postconditions (and (not (= TurnIndicator::state1::Flash_Ctrl@0::emerSwitch TurnIndicator::state0::Flash_Ctrl@0::emerSwitch)) (= TurnIndicator::state1::Flash_Ctrl@0::tilLevel TurnIndicator::state0::Flash_Ctrl@0::tilLevel) (= TurnIndicator::state1::Flash_Ctrl@0::tilOld TurnIndicator::state0::Flash_Ctrl@0::tilOld) (= TurnIndicator::state1::Output_Ctrl@0::ctr TurnIndicator::state0::Output_Ctrl@0::ctr) (= TurnIndicator::state1::Output_Ctrl@0::lOld TurnIndicator::state0::Output_Ctrl@0::lOld) (= TurnIndicator::state1::Output_Ctrl@0::rOld TurnIndicator::state0::Output_Ctrl@0::rOld) (= TurnIndicator::state1::Output_Ctrl@0::left TurnIndicator::state0::Output_Ctrl@0::left) (= TurnIndicator::state1::Output_Ctrl@0::right TurnIndicator::state0::Output_Ctrl@0::right) (= TurnIndicator::state1::Output_Ctrl@0::lampsLeft TurnIndicator::state0::Output_Ctrl@0::lampsLeft) (= TurnIndicator::state1::Output_Ctrl@0::lampsRight TurnIndicator::state0::Output_Ctrl@0::lampsRight))))
