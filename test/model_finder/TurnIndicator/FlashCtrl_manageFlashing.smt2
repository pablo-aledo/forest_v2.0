...
(assert (= preconditions (= TurnIndicator::state0::Flash_Ctrl@0::emerSwitch false)))
(assert (= postconditions (and (=> (= TurnIndicator::state1::Flash_Ctrl@0::tilLevel (_ bv0 8)) (and (= TurnIndicator::state1::Output_Ctrl@0::left true) (= TurnIndicator::state1::Output_Ctrl@0::right false))) (=> (= TurnIndicator::state1::Flash_Ctrl@0::tilLevel (_ bv2 8)) (and (= TurnIndicator::state1::Output_Ctrl@0::right true) (= TurnIndicator::state1::Output_Ctrl@0::left false))) (=> (= TurnIndicator::state1::Flash_Ctrl@0::tilLevel (_ bv1 8)) (and (= TurnIndicator::state1::Output_Ctrl@0::left false) (= TurnIndicator::state1::Output_Ctrl@0::right false))) (=> (and (= TurnIndicator::state1::Output_Ctrl@0::left true) (= TurnIndicator::state0::Output_Ctrl@0::left false)) (= TurnIndicator::state1::Output_Ctrl@0::ctr (_ bv0 8))) (=> (and (= TurnIndicator::state1::Output_Ctrl@0::right true) (= TurnIndicator::state0::Output_Ctrl@0::right false)) (= TurnIndicator::state1::Output_Ctrl@0::ctr (_ bv0 8))) (=> (and (or (= TurnIndicator::state1::Output_Ctrl@0::left false) (= TurnIndicator::state0::Output_Ctrl@0::left true)) (or (= TurnIndicator::state1::Output_Ctrl@0::right false) (= TurnIndicator::state0::Output_Ctrl@0::right true))) (= TurnIndicator::state1::Output_Ctrl@0::ctr TurnIndicator::state0::Output_Ctrl@0::ctr)) (= TurnIndicator::state1::Flash_Ctrl@0::emerSwitch TurnIndicator::state0::Flash_Ctrl@0::emerSwitch) (= TurnIndicator::state1::Flash_Ctrl@0::tilOld TurnIndicator::state0::Flash_Ctrl@0::tilLevel) (= TurnIndicator::state1::Flash_Ctrl@0::tilLevel TurnIndicator::state0::Flash_Ctrl@0::tilLevel) (= TurnIndicator::state1::Output_Ctrl@0::lOld TurnIndicator::state0::Output_Ctrl@0::lOld) (= TurnIndicator::state1::Output_Ctrl@0::rOld TurnIndicator::state0::Output_Ctrl@0::rOld) (= TurnIndicator::state1::Output_Ctrl@0::lampsLeft TurnIndicator::state0::Output_Ctrl@0::lampsLeft) (= TurnIndicator::state1::Output_Ctrl@0::lampsRight TurnIndicator::state0::Output_Ctrl@0::lampsRight))))
